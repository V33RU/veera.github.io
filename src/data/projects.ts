...
export const projects: Project[] = [
  { name: "Akhanda-OS", year: 2026, track: "Active", description: "Embedded hacking OS / security platform" },
  { name: "RFSploit", year: 2026, track: "Active", description: "RF exploitation toolkit (SDR, signals, protocol attacks)" },
